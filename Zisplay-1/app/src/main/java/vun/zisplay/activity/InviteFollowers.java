...
public class InviteFollowers extends ZisplayBaseActivity implements FacebookDialog.Callback{
    ...
    private static final String SMS_SENT = "vun.zisplay";
    private static final String SMS_DELIVERED = "vun.zisplay";
    LocalData localData;
    @Override
    ...
    {
        Intent intent = new Intent(InviteFollowers.this, Dashboard.class);
...
//        sendIntent.putExtra("sms_body", "Hey! Follow my new designs on Zisplay. <a href='http://zisplay.com/f/abcdf'> Follow</a>");
