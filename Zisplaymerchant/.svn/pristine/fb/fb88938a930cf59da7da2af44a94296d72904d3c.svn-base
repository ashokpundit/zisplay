...
//    String location;
    ...
    int unreadMessage=0;
    int noOfProducts=0;
    int noOfDraftProducts=0;
    int productLikes=0;
    int noOfProductInquiries=0;
    int productViews=0;
    int profileViews=0;
    int totalPayments=0;
    ...
    public int getNoOfProductInquiries() {
        return noOfProductInquiries;
    }

    public void setNoOfProductInquiries(int noOfProductInquiries) {
        this.noOfProductInquiries = noOfProductInquiries;
    }
    ...
    public int getNoOfDraftProducts() {
        return noOfDraftProducts;
    }

    public void setNoOfDraftProducts(int noOfDraftProducts) {
        this.noOfDraftProducts = noOfDraftProducts;
    }
