...
public class InviteBySMS extends ZisplayBaseActivity implements TextWatcher{
...
//Running AsyncLoader with adapter and search text as parameters
        ...
        {
            AnalyticsManager.getInstance().raiseException("InviteBySMS",e);
            e.printStackTrace();
        }
    }
    @Override
...
srchBox.addTextChangedListener(this);
...
//Ending Activity and passing result
    ...
    class AsyncContactLoader extends AsyncTask<String,G_ContactList,G_ContactList>
    {
        ...
        protected void onPreExecute()
        {
            ...
            pgdlg = ProgressDialog.show(InviteBySMS.this, "Please Wait", "Loading Contacts with Phone Numbers", true);
        }
