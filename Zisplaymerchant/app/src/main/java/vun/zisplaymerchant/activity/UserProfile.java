...
public class UserProfile extends ActionBarActivity {
    ...
    void loadUser(String userId)
    {
        ...
        omgService.getUserPublicProfile(userId, new Callback<AppUser>() {
            @Override
            public void success(AppUser appUser, Response response) {
                ...
                String imagePath=AppConstants.CLOUDINARY_FACEBOOK_URL+"w_120,h_120/"+appUser.getFacebookId()+".jpg";
//                ImageDownloader imgDownloder=new ImageDownloader();
//                imgDownloder.download(AppConstants.CLOUDINARY_URL,imageView);
                Picasso.with(UserProfile.this).load(imagePath).into(imageView);
                if (pgdlg.isShowing())
                    pgdlg.dismiss();
            }
