...
public class ChatHistory extends ZisplayBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cla = adapter;
        pgdlg = ProgressDialog.show(this, "Please Wait", "Loading messages...", true);
...
//            imageDetails.setText( CapturedImageDetails );
    ...
    public void sendMessage(View v)
    {
        ...
        TypedString product=null;
        if(productId!=null)
        product=new TypedString(productId);
        omgService.sendMessage(new TypedString(otherUserId), new TypedString(merchantId), new TypedString(otherUserName), new TypedString(merchantName), new TypedString(message),product, imageFile, new Callback<Message>() {
                        @Override
...
//            WebView webview = (WebView) view_row.findViewById(R.id.itemView);
            ...
            else
            {
                ...
                chk_contact.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        ...
                        String[] urls=extractLinks(text);
                       if(urls[0].startsWith(AppConstants.SERVER_BASE_URL+"/pay")) {
                           String id = Message.getId();
                           Intent chatViewIntent = new Intent(ChatHistory.this, PaymentView.class);
                           Log.d("url",urls[0]+"?access_token="+localData.getData("accessToken"));
                           chatViewIntent.putExtra("url", urls[0]+"?access_token="+localData.getData("accessToken"));
